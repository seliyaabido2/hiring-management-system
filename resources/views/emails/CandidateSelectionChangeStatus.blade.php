        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
                ...
                <p>
                    I am pleased to inform you that {{$mailDataResponce['candidateName']}} has been {{ $mailDataResponce['status'] ." in ". $mailDataResponce['Round']}}  for the {{$mailDataResponce['job_title']}} position at {{$mailDataResponce['company_name']}}.
                </p>


                <p>
                    If you have any inquiries or require additional information, feel free to reach out.
                </p>
