...
$(document).on('change', '.job-data', function() {
    ...
    $.ajax({
    url: '{{ route('admin.employerReports.getJobs') }}',
    method: 'POST',
    data: {
...
<script>
    ...
    $('#report-filter').validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: '{{ route('admin.employerReports.store') }}',
                method: 'POST',
                ...
                success: function(response) {
                    ...
                    if (response.status == true) {
                        ...
                        $.each(responseObject, function(index, object) {
                            ...
                            if(object.employer_name != undefined){
                        ...
                        iziToast.success({
                            title: 'Employer report genrate successfully.',
                            message: response,
                            position: 'topRight',
