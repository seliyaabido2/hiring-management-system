...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.candidates.title_singular') }}
    </div>
...
?>
        <b>Basic Details</b>
        <div class ="re-resume-upload " style="display:{{ isset($user->resume_path) ? 'none' : 'block' }}">
        ...
        <div class="resume-file" style="display:{{ isset($user->resume_original_name) ? 'block' : 'none' }}">
            <div class="row ">
            <p>Attached resume: {{ $user->resume_original_name ?? '' }}
        ...
        <div class="candidate-form" style="display:{{ isset($user->resume_path) ? 'block' : 'none' }}">
            <form action="{{ route('admin.candidate.store') }}" method="POST" id="AddCandidateForm" autocomplete="off" enctype="multipart/form-data" checkUniqueEmailOrContact>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="hidden" id="resume_path" name="resume_path" value="{{ isset($user) ? $user->resume_path : "" }}">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6 other_any_other_langauge" style="display:none">
                    <label for="other_any_other_langauge">{{ trans('cruds.employerJobs.fields.other_any_other_langauge') }}*</label>
                    <input type="text" id="other_any_other_langauge" name="other_any_other_langauge" class="form-control" placeholder="{{ trans('cruds.employerJobs.fields.other_any_other_langauge') }}" >
...
@include('admin.customJs.candidates.create')
@endpush
