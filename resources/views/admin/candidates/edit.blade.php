...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.candidates.title_singular') }}
    </div>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.candidate.update', [$candidate->id]) }}" method="POST" id="EditCandidateForm"
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2bs4" id="job_preference" name="job_preference">
                        ...
                        <option value="Service Focused" {{ $candidate->job_preference == 'Service Focused' ? 'selected' : '' }}>Service Focused</option>
                        <option value="Sales Focused" {{ $candidate->job_preference == 'Sales Focused' ? 'selected' : '' }}>Sales Focused</option>
                        <option value="Both" {{ $candidate->job_preference == 'Both' ? 'selected' : '' }}>Both</option>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2bs4" id="license_candidate_banking_finance"
                        ...
                        <option value="Yes"
                            {{ $candidate->license_candidate_banking_finance == 'Male' ? 'Yes' : '' }}>Yes</option>
                        <option value="No"
                            {{ $candidate->license_candidate_banking_finance == 'Male' ? 'No' : '' }}>No</option>
                    </select>
