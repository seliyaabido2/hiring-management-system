...
<div class="card">
    ...
    <div class="card-body col-md-6">
        <form action="{{ route("admin.contracts.store") }}" id="add-contracts-form" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                ...
                <div class="input-item">
                    <textarea id="description" name="description" style="min-width: 100%" placeholder="Contract Description"></textarea>
                </div>
            ...
            <div class="form-group {{ $errors->has('expire_alert') ? 'has-error' : '' }}">
                ...
                <input type="number" id="expire_alert" name="expire_alert" class="form-control" placeholder="Enter digit days">
...
@include('admin.customJs.contracts.create')
