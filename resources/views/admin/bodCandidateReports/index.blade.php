...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.bodCandidateReports.title_singular') }} {{ trans('global.list') }}
    </div>
        ...
        <form id ="report-filter">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4  {{ $errors->has('from_date') ? 'has-error' : '' }}">
                    <label for="from_date">{{ trans('cruds.bodCandidateReports.fields.from_date') }}*</label>
                <div class='input-group date' id='from_date'>
                    ...
                    <p class="helper-block">
                        {{ trans('cruds.bodCandidateReports.fields.from_date_helper') }}
                    </p>
                    </div>
                </div>

                <div class="form-group col-md-4  {{ $errors->has('to_date') ? 'has-error' : '' }}">
                    <label for="to_date">{{ trans('cruds.bodCandidateReports.fields.to_date') }}*</label>
                <div class='input-group date' id='to_date'>
                    ...
                    @endif
                    <p class="helper-block">
                        {{ trans('cruds.bodCandidateReports.fields.to_date_helper') }}
                    </p>
                    </div>
                </div>
...
@include('admin.customJs.bodCandidateReports.index')
@endpush
