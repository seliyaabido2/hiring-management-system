    ...
    <div class="card-body">
        <form action="{{ route("admin.appointments.update", [$appointment->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('client_id') ? 'has-error' : '' }}">
                ...
                <select name="client_id" id="client" class="form-control select2bs4" required>
            ...
            <div class="form-group {{ $errors->has('employee_id') ? 'has-error' : '' }}">
                ...
                <select name="employee_id" id="employee" class="form-control select2bs4" >
            ...
            <div class="form-group {{ $errors->has('services') ? 'has-error' : '' }}">
                ...
                <select name="services[]" id="services" class="form-control select2bs4" multiple="multiple">
