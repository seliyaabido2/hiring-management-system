...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.bodCandidates.title_singular') }}
    </div>
...
?>
        ...
        <div class="candidate-form" style="display:{{ isset($user->resume_path) ? 'block' : 'none' }}">
            <form action="{{ route('admin.bodCandidate.store') }}" method="POST" id="AddCandidateForm" autocomplete="off"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('location') ? 'has-error' : '' }}">
                            ...
                            <input type="text" name="location" id="location" class="form-control" value="{{ isset($user) ? $user->address : "" }}" placeholder="Choose Location">
                ...
                <div>
                    {{-- @if (isset($user->resume_path)) --}}
                        <button class="btn btn-info" type="submit" >{{ trans('global.save') }}</button>
                    {{-- @else
                        <div class="d-inline-block" tabindex="0" data-toggle="tooltip" data-placement="bottom" title="Please upload resume">
                            <button class="btn btn-info" type="submit" style="pointer-events: none;" disabled>{{ trans('global.save') }}</button>
                        </div>
                    @endif --}}
...
@include('admin.customJs.bodCandidates.create')
@endpush
