<script>
    var dataTable = $('#candidateTbl').DataTable({
        ...
        ajax: {
            url: '<?php echo e(route('admin.candidate.getCandidateDatatable')); ?>',
            type: 'GET',
        ...
        initComplete: function() {
            var headerRow = $('<tr>').appendTo('#candidateTbl thead');
    ...
    $('#Bulkdelete').on('click', function() {
        ...
        $('.delete-form').attr('action', "<?php echo e(url('admin/candidate/massDestroy')); ?>?ids=" +
            checkedIds.toString());
    ...
    $(document).on('click', '.delete-btn', function(){
            ...
            $('#delete-model').modal('show');
            $('.delete-form').attr('action', "<?php echo e(url('admin/candidate/destroy')); ?>?id=" + itemId);
        });
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bod/resources/views/admin/customJs/candidates/index.blade.php ENDPATH**/ ?>