<script>
    $(document).ready(function() {
        ...
        var dataTable = $('#tblApplyjob').DataTable({
            ...
            ajax: {
                url: '<?php echo e(route('admin.employerJobs.ActiveJobDatatable')); ?>',
                type: 'GET',
                data: function(d) {
    ...
    function CalltblCandidateJobFn() {
        ...
        var candidateDataTable = $('#tblCandidateJob').DataTable({
            ...
            ajax: {
                url: '<?php echo e(route('admin.employerJobs.candidateDatatabes')); ?>',
                type: 'GET',
                data: function(d) {
                    // Add dynamic parameters here
                    d.rangeValue = formControlRange.val();
        ...
        $('#submitformBtn').on('click', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(route("admin.employerJobs.bulkPostApplyJob")); ?>', // Replace with your route name
                type: 'POST',
                data: formData,
                beforeSend: function() {
                ...
                success: function(response){
                    ...
                    if(response.status == true){
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(url('admin/employerJobs/bulk-apply-job')); ?>";
                        }, 2500);
    ...
    $(document).ready(function() {
        ...
        $('#getCheckedIds').on('click', function() {
            ...
            $('.delete-form').attr('action',
                "<?php echo e(url('admin/employerJobs/post-apply-job')); ?>?candidate=" +
...
<script>
    function selectedCandidateChecked() {
        ...
        var selectedCandidateData = <?php echo json_encode(session('selectedCanidateData')); ?>;
...
<script>
    $(document).ready(function() {
        $('.delete-btn').click(function() {
            ...
            $('#delete-model').modal('show');
            $('.delete-form').attr('action', "<?php echo e(url('admin/notifications/destroy')); ?>?id=" + itemId);
        });
...
<?php /**PATH /var/www/html/laravel/bod/resources/views/admin/customJs/employerJobs/bulkApplyJob.blade.php ENDPATH**/ ?>