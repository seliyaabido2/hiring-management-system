...
$(document).on('change', '.job-data', function() {
    ...
    $.ajax({
    url: '<?php echo e(route('admin.bodCandidateReports.getJobs')); ?>',
    method: 'POST',
    data: {
...
<script>
    ...
    $('#report-filter').validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: '<?php echo e(route('admin.bodCandidateReports.store')); ?>',
                method: 'POST',
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bod/resources/views/admin/customJs/bodCandidateReports/index.blade.php ENDPATH**/ ?>