...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.deactive')); ?> <?php echo e(trans('cruds.employerJobs.title_singular')); ?> <?php echo e(trans('global.list')); ?>
                ...
                <tbody>
                     ...
                     <?php $__currentLoopData = $EmployerJob; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($job->id); ?>">
                            ...
                            <td>
                                <?php $url = "admin/employerJobs/chageJobRequestStatus/".$job->id."/Active"; ?>
                                <a href="<?php echo e(url($url)); ?>" class="btn btn-xs btn-success">Active</a>

                                <?php if(!empty($job->savedJobTemplate)): ?>
                                <a class="btn btn-xs btn-warning" href="<?php echo e(route('admin.appliedJobs.unSavedJobTemplate', ['id' =>encrypt_data($job->id) ])); ?>">
                                    un-save Job template
                                </a>
                                <?php else: ?>
                                <a class="btn btn-xs btn-success" href="<?php echo e(route('admin.appliedJobs.savedJobTemplate', ['id' =>encrypt_data($job->id) ])); ?>">
                                    Save Job template
                                </a>
                                <?php endif; ?>
                            </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/bod/resources/views/admin/employerJobs/DeActiveJobs.blade.php ENDPATH**/ ?>