...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('cruds.bodCandidateReports.title_singular')); ?> <?php echo e(trans('global.list')); ?>
        ...
        <form id ="report-filter">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4  <?php echo e($errors->has('from_date') ? 'has-error' : ''); ?>">
                    <label for="from_date"><?php echo e(trans('cruds.bodCandidateReports.fields.from_date')); ?>*</label>
                <div class='input-group date' id='from_date'>
                    ...
                    <p class="helper-block">
                        <?php echo e(trans('cruds.bodCandidateReports.fields.from_date_helper')); ?>
                ...
                <div class="form-group col-md-4  <?php echo e($errors->has('to_date') ? 'has-error' : ''); ?>">
                    <label for="to_date"><?php echo e(trans('cruds.bodCandidateReports.fields.to_date')); ?>*</label>
                <div class='input-group date' id='to_date'>
                    ...
                    <?php endif; ?>
                    <p class="helper-block">
                        <?php echo e(trans('cruds.bodCandidateReports.fields.to_date_helper')); ?>
...
<?php echo $__env->make('admin.customJs.bodCandidateReports.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopPush(); ?>


<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bod/resources/views/admin/bodCandidateReports/index.blade.php ENDPATH**/ ?>