<script>
   var dataTable = $('#subAdminTbl').DataTable({
    ...
    ajax: {
        url: '<?php echo e(route('admin.SubAdmin.getSubAdminDatatable')); ?>',
        type: 'GET',
    },
    columns: [
...
<?php /**PATH /var/www/html/laravel/bod/resources/views/admin/customJs/subAdmin/index.blade.php ENDPATH**/ ?>