...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.bodCandidates.title_singular')); ?>
    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('admin.bodCandidate.update', [$candidate->id])); ?>" method="POST" id="EditCandidateForm"
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2bs4" id="job_preference" name="job_preference">
                        ...
                        <option value="Service Focused"
                            <?php echo e($candidate->job_preference == 'Service Focused' ? 'selected' : ''); ?>>Service Focused
                        </option>
                        <option value="Sales Focused"
                            <?php echo e($candidate->job_preference == 'Sales Focused' ? 'selected' : ''); ?>>Sales Focused
                        </option>
                        <option value="Both" <?php echo e($candidate->job_preference == 'Both' ? 'selected' : ''); ?>>Both
                        </option>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group <?php echo e($errors->has('job_type') ? 'has-error' : ''); ?>">
                        ...
                        <select class="form-control select2bs4" id="job_type" name="job_type">
                            ...
                            <option value="Full Time" <?php echo e($candidate->job_type == 'Full Time' ? 'selected' : ''); ?>>Full
                                Time</option>
                            <option value="Part Time" <?php echo e($candidate->job_type == 'Part Time' ? 'selected' : ''); ?>>Part
                                Time</option>
            ...
            <div class="row">
                <div class="form-group col-md-6 how_many_experience" style="display: <?php echo $candidate->experience_sf === 'Yes' ? 'block' : 'none'; ?>">
                    ...
                    <select class="form-control select2bs4" id="how_many_experience" name="how_many_experience">
                        <option value="" <?php if($candidate->how_many_experience === ''): ?> selected <?php endif; ?>>Select Experience
                        </option>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2bs4" id="license_candidate_banking_finance"
                        ...
                        <option value="">Select</option>
                        <option value="Yes" <?php if($candidate->license_candidate_banking_finance === 'Yes'): ?> selected <?php endif; ?>>Yes</option>
                        <option value="No" <?php if($candidate->license_candidate_banking_finance === 'No'): ?> selected <?php endif; ?>>No</option>
                    </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/bod/resources/views/admin/bodCandidates/edit.blade.php ENDPATH**/ ?>