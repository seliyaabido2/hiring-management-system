<script>
   var dataTable = $('#employerTbl').DataTable({
    processing: true,
    serverSide: true,
    lengthMenu: [10, 25, 50, 100, 500],
    ajax: {
        url: '<?php echo e(route('admin.employer.getEmployerDatatable')); ?>',
        type: 'GET',
    },
    columns: [
        ...
        {
            data: 'employer_detail.authorized_name', // Update to the nested property used in the server-side code
            name: 'EmployerDetail.authorized_name'
        },
        {
            data: 'employer_detail.company_name',
            name: 'EmployerDetail.company_name'
        },
        {
            data: 'job_posts_count',
            name: 'job_posts_count'
        },
        {
            data: 'total_hired_candidates_count',
            name: 'total_hired_candidates_count'
        },
        {
            data: 'email',
            name: 'email'
        ...
        {
            data: 'employer_detail.phone_no',
            name: 'EmployerDetail.phone_no'
        },
        {
            data: 'employer_detail.location', // Update to the nested property used in the server-side code
            name: 'EmployerDetail.location'
        },
        {
    ...
    initComplete: function () {
        var headerRow = $('<tr>').appendTo('#employerTbl thead');
...
<?php /**PATH /var/www/html/laravel/bod/resources/views/admin/customJs/employer/index.blade.php ENDPATH**/ ?>