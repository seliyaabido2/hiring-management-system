...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.create')); ?> <?php echo e(trans('cruds.candidates.title_singular')); ?>
...
?>
        ...
        <div style="display:<?php echo e(isset($user->resume_path) ? 'block' : 'none'); ?>">
            <form action="<?php echo e(route('admin.candidate.store')); ?>" method="POST" id="AddCandidateForm" autocomplete="off" enctype="multipart/form-data" checkUniqueEmailOrContact>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6 other_any_other_langauge" style="display:none">
                    <label for="other_any_other_langauge"><?php echo e(trans('cruds.employerJobs.fields.other_any_other_langauge')); ?>*</label>
                    <input type="text" id="other_any_other_langauge" name="other_any_other_langauge" class="form-control" placeholder="<?php echo e(trans('cruds.employerJobs.fields.other_any_other_langauge')); ?>" >
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close cancel-btn cancelCandidateData" data-dismiss="modal" aria-label="Close">
...
<?php echo $__env->make('admin.customJs.candidates.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/bod/resources/views/admin/candidates/create.blade.php ENDPATH**/ ?>