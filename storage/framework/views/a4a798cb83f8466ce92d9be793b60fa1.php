        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 30px;" width="596">
              ...
              <img style="width: 180px; max-width: 180px; height: 85px; max-height: 85px; text-align: center; color: #ffffff;" alt="Logo" src="<?php echo e(url('images/bod-logo.png')); ?>" align="center" width="180" height="85">
    ...
    <table align="center" style="text-align: left; vertical-align: top; width: 600px; max-width: 600px; background-color: #ffffff;" width="600">
        <tbody>
          <tr>
            ...
            <p>
                Hello! Dear <?php echo e($user->first_name); ?>,
            </p>
            <p>
            ...
            <p style="text-align: center;">
              ...
              <a href="<?php echo e($actionUrl); ?>" target="_blank" style="background-color: #000000; font-size: 15px; line-height: 22px; font-family: 'Helvetica', Arial, sans-serif; font-weight: normal; text-decoration: none; padding: 12px 15px; color: #ffffff; border-radius: 5px; display: inline-block; mso-padding-alt: 0;">
...
<?php /**PATH /var/www/html/laravel/bod/resources/views/emails/CustomForgotPassword.blade.php ENDPATH**/ ?>