<script>
    ...
    function submitFormResume() {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.resumeFetchData.upload")); ?>',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bod/resources/views/admin/customJs/employerJobs/applyJob.blade.php ENDPATH**/ ?>