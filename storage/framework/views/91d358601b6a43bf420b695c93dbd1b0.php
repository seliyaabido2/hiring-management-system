<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.employerJobs.title_singular')); ?>

        </div>
        <div class="card-body">
            <form action="<?php echo e(route('admin.employerJobs.update', [$employerjob->id])); ?>" method="POST" id="employerJobForm"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control select2bs4" id="job_shift" name="job_shift">
                                ...
                                <option value="Work from home" <?php if($employerjob->job_shift === 'Work from home'): ?> selected <?php endif; ?>>Work from
                                    home</option>
                                    <option value="Hybrid"  <?php if($employerjob->job_type == 'Hybrid'): ?> selected <?php endif; ?>>Hybrid</option>
                            </select>
                        ...
                        <div class="form-group col-md-6  <?php echo e($errors->has('job_start_date') ? 'has-error' : ''); ?>">
                            ...
                            <div class='input-group date' id='job_start_date'>
                                ...
                                <input type='text' placeholder="job Launch date" class="form-control"
                                    value="<?php echo e(old('job_start_date', isset($employerjob) ? \Carbon\Carbon::createFromFormat('Y-m-d', $employerjob->job_start_date)->format('d-m-Y') : '')); ?>"
                                    name="job_start_date" />
                ...
                <div class="row">
                   ...
                   <span class="input-group-text" id="basic-addon1">$</span>
                    ...
                    <?php if($employerjob->status == 'Hold'): ?>
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control select2bs4" id="status" name="status">
                            <option value="Hold" <?php echo e($employerjob->status == 'Hold' ? 'selected' : ''); ?>>Hold
                            </option>
                        </select>
                    </div>
                <?php else: ?>
                    <div class="form-group col-md-6">
                        <label for="status"><?php echo e(trans('cruds.employerJobs.fields.status')); ?>*</label>
                        <select class="form-control select2bs4" id="status" name="status">
                            <!-- <option value="Hold" <?php echo e($employerjob->status == 'Hold' ? 'selected' : ''); ?>>Hold</option> -->
                            <option value="Active" <?php echo e($employerjob->status == 'Active' ? 'selected' : ''); ?>>Active
                            </option>
                            <option value="Deactive" <?php echo e($employerjob->status == 'Deactive' ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bod/resources/views/admin/employerJobs/edit.blade.php ENDPATH**/ ?>